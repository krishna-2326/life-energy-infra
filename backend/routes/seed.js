...
// GET /api/seed - Trigger database seeding via URL
router.get('/', async (req, res) => {
  try {
    const adminEmail = await runSeeder();
    res.json({
      success: true,
      message: `Database seeded successfully! Admin created for ${adminEmail}. You can now log into your live admin panel.`
    });
  } catch (error) {
...
module.exports = { router, runSeeder };
